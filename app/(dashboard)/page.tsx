...
export default async function OverviewPage() {
  ...
  return <>
    ...
    <KpiStrip items={[
      {label:'Användning i år · demo',value:fmtCompact(totals.requestsYtd),delta:{value:fmtPercent(totals.requestsGrowth,true),positive:true},hint:'mot samma period'},
    ...
    <section className="flex flex-col gap-5"><SectionHeader title="Era informationsprodukter" description="Tilldelat till KTH · öppna en produkt för detaljer" /><ResourceExplorer rows={resources} showCommercial={commercial} /></section>
